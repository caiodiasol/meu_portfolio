        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className={`space-y-8 ${mounted ? "animate-fade-in-up" : "opacity-0"}`}>
            <div className="flex items-center gap-6 mb-8">
              <div className="w-24 h-24 lg:w-32 lg:h-32 rounded-full overflow-hidden border-4 border-primary/20 bg-card flex items-center justify-center">
                <img src="/perfil.jpg" alt="foto perfil" className="w-full h-full object-cover object-center" />
              </div>
              <div>
                <h1 className="text-4xl lg:text-6xl font-bold text-balance">Caio Dias</h1>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <Button
                ...
                className="border-primary text-primary hover:bg-primary hover:cursor-pointer hover:text-primary-foreground"
              >
                Entrar em Contato
              </Button>
            </div>
          ...
          <div className={`${mounted ? "animate-fade-in-up" : "opacity-0"} lg:delay-200`}>
            <div className="bg-card border border-border rounded-lg p-6 font-mono text-sm">
              ...
              <div className="space-y-2">
                ...
                <div className="ml-4">
                  <span className="text-green-400">name</span>: <span className="text-orange-300">&apos;Caio Dias&apos;</span>,
                </div>
                <div className="ml-4">
                ...
                <div className="ml-8">
                  <span className="text-orange-300">&apos;Django&apos;</span>, <span className="text-orange-300">&apos;Python&apos;</span>,{" "}
                  <span className="text-orange-300">&apos;JavaScript&apos;</span>,{" "}
                </div>
                <div className="ml-8">
                  <span className="text-orange-300">&apos;Node.js&apos;</span>, <span className="text-orange-300">&apos;PostgreSQL&apos;</span>,{" "}
                  <span className="text-orange-300">&apos;Git&apos;</span>{" "}
                </div>
                <div className="ml-4">],</div>
                <div className="ml-4">
                  <span className="text-green-400">passion</span>:{" "}
                  <span className="text-orange-300">&apos;Implementar soluções centradas na experiência do usuário&apos;</span>
                </div>
                <div>{`}`}</div>
              </div>
            </div>
